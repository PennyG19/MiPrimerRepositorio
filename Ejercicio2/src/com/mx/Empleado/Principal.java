...
public class Principal {
	...
	public static void main(String args[]) {
		...
		Empleado emp1 = new Empleado("David", "Gonzales", "Jimenez", 8517418754L, 58, 6500.13);
		...
		do {
			...
			//DECLARACION  DEL BLOQUE TRY-CATCH P'ARA EVITAR QUE EL PROGRAMA SE DETENGA 
			...
			try {
				...
				case 1:
					...
					//INSTANCIAR CON LOS VALORES RECIBIDOS
			   ...
			   case 4:
				   ...
				   imprimirDatos(imp);
				   if(imp.lista.size() > 0){
					   System.out.println("Indique el indice a eliminar");
					   indice = scan.nextInt();
					   if(indice >= 0 && indice < imp.lista.size()) {
						   imp.delete(indice);
			   ...
			   case 7:
				   ...
				   break;
				   default:
					   System.out.println("Indice fuera de rago, intenta con uno dentro del menu");
					   break;
				}		
		...
		//ES U METODO(MIEMBRO)ESTATICO A LA CLASE Y ESTE NOS PERMITE PODER USARLO EN CUALQUIER PARTE
		//SIEMPRE Y CUENADO ESTE DENTRO DE LA CLASE
